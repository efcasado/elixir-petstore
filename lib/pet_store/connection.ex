defmodule PetStore.Connection do
  ...
  Additional middleware can be set in the compile-time or runtime configuration:
      ...
      config :tesla, PetStore.Connection,
        base_url: "https://petstore3.swagger.io/api/v3",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :elixir_petstore,
        :base_url, "https://petstore3.swagger.io/api/v3"
  """
  ...
  - `options`: a keyword list of PetStore.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:elixir_petstore, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - PetStore 1.0.0 - elixir"
        )
      )
